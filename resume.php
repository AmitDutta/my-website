...
<div id="wrap">
	...
	<div  id="nav">
		<ul>
			...
			<li id="current"><a href="resume.php">CV</a></li>
	...
	<div id="content-wrap-resume">            
		...
		<div id="resumeMain">
                    ...
                    <h2><a href="Files/cv-of-AmitDutta.pdf">Download (PDF)</a></h2>
                    <br />
...
<!--                    <div id = "cv" style="background-color:#ffffff; overflow:auto;">
                    ...
                    <iframe src="http://docs.google.com/gview?url=http://www.amitdutta.net/Files/cv-of-AmitDutta.pdf&embedded=true" style="width:830px; height:700px;" frameborder="0">
                    </iframe>
